...
class LiveStreamTest {
    ...
    void create_new_mutable_live_stream() {
        ...
        stream.setDescription("Spring Boot is very convenient to use when building REST APIs; " +
                "it allows you to start with minimal configurations.But there’s always room for trouble " +
                "to creep in. Join us for the next IntelliJ IDEA Live Stream to learn how best to avoid " +
                "this trouble in developing your project. During the February show, Dan Vega will show us " +
                "how to make sure we’re following good practices when working with Spring Initializr.");
    ...
    void create_new_immutable_live_stream() {
        ImmutableLiveStream stream = new ImmutableLiveStream(
                ...
                "Spring Boot is very convenient to use when building REST APIs; it allows you to " +
                        "start with minimal configurations.But there’s always room for trouble to creep in. " +
                        "Join us for the next IntelliJ IDEA Live Stream to learn how best to avoid this " +
                        "trouble in developing your project. During the February show, Dan Vega will show us " +
                        "how to make sure we’re following good practices when working with Spring Initializr.",
    ...
    void create_new_record_live_stream() {
        LiveStream stream = new LiveStream(
                ...
                "Spring Boot is very convenient to use when building REST APIs; " +
                        ...
                        "trouble to creep in. Join us for the next IntelliJ IDEA Live Stream to learn how " +
                        "best to avoid this trouble in developing your project. During the February show, " +
        ...
        //assertEquals(6, stream.getClass().getFields().length);
    }
}